...
class UserProfileSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['id', 'email', 'name', 'profile_image', 'phone_number', 'citizenship_id_number',"citizenship_image","status","is_admin","updated_at","delivery","payment","store"]

class UpdateUserProfileSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['id', 'name', 'profile_image', 'phone_number', 'citizenship_image', 'citizenship_id_number',"delivery","payment","store"]
        read_only_fields = ['id']
...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ('id', 'name', 'email','profile_image', 'phone_number', 'citizenship_id_number',"citizenship_image","status","is_admin","updated_at","delivery","payment","store")
...
class UserUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['id', 'email', 'name', 'is_active', 'is_admin', 'created_at', 'updated_at', 'profile_image', 'phone_number', 'citizenship_image', 'citizenship_id_number', 'status',"store"]
